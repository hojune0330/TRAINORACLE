...
| `OI-PG-MICROCYCLE-CALENDAR-MAPPING-001` | P2 | NO | OPEN | 9.5-day reference cycle to 7-day calendar output needs final mapping. | Define mapping and display policy. |
