# WO017 Owner Direction

```yaml
owner_choices: 권장 / 권장 / 권장+b
...
- `OWNER-017-01`: optional one-context router.
- `OWNER-017-02`: plan interest is service preparing only.
- `OWNER-017-03`: factual records now; decoration needs separate acceptance.
