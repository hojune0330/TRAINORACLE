...
| `TRAINING_PLAN_FORMATION_AND_ADAPTATION_SPEC.md` | 9.5일 안에 MAIN 2-3회와 사이 부하를 실제 후보·조정 계약으로 만들기 위해 | Draft created. 소유자 결정은 기록됨; 코치 규칙, 통계 기준, Plan Generator/Calendar binding, 파일럿 프로토콜 등 6개 blocker가 남아 있음 |
...
1. `TRAINING_PLAN_METHOD_DECISION.md`와 Formation/Adaptation draft를 함께 검토하고 여섯 blocker를 결정.
...
5. 실제 D9 evaluator와 이후 Formation contract runtime evidence 확보.
...
- It is still draft-for-review with six canonical blockers and is not Plan Generator/Calendar binding or runtime evidence.
