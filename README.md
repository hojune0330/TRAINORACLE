...
**현재 공개 앱: [TrainOracle 일지 열기](https://hojune0330.github.io/TRAINORACLE/)**

이 브랜치의 훈련계획 베타는 독립 검토와 CI를 통과한 뒤 공개 앱에 배포합니다. 배포되면 회원가입 없이 훈련계획 후보를 만들고 선택해 진행 상태를 남길 수 있습니다. 현재 계획과 기록은 사용 중인 브라우저와 기기에만 저장됩니다.

| 이번 베타 배포 범위 | 아직 준비 중인 것 |
|---|---|
