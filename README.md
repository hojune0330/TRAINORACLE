...
| 안전 확인 후 7일·9일·10일 베타 계획 후보 2개 생성 | 정식 9.5일 적응형 계획과 코치 규칙 |
...
브라우저 데이터 삭제나 기기 변경 전에는 앱의 내보내기 기능으로 백업해 주세요. 훈련계획 베타는 정확한 페이스를 발명하지 않고 시간·RPE 범위만 제안하며, 최근 일지나 현재 확인에서 통증·부상·몸 이상이 있거나 불명확하면 후보를 만들지 않습니다. 최근 일지의 존재는 표시하지만 아직 그 수치를 처방에 반영하지 않습니다. 문의와 베타 의견은 공개 저장소가 아니라 [앱 안의 문의 게시판](https://hojune0330.github.io/TRAINORACLE/?feedback=1)에 남깁니다.
