...
status: MERGE_ELIGIBLE_PENDING_GITHUB_CI_AND_LIVE_DEPLOYMENT
...
| GitHub CI·공개 URL 검증 | PR 병합 후 실행 |
...
PR 병합 뒤 실제 `main` 커밋, GitHub Actions 실행, 공개 URL 왕복 검증 결과를 이 절 또는 PR의 배포 증거에 남긴다.
