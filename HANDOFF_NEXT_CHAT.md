> **역사 인수 기록입니다. 현재 제품이나 다음 구현 작업의 기준으로 사용하지 마세요.**
> 먼저 [`CURRENT_IMPLEMENTATION_HANDOFF_2026-07-30.md`](./CURRENT_IMPLEMENTATION_HANDOFF_2026-07-30.md)를 읽고, 그 문서가 가리키는 현재 `main`과 GitHub Actions 상태를 다시 확인하세요.
> 아래 내용은 2026-06-22 당시 디자인 작업의 맥락을 보존합니다. 삭제하지 않되, 이미 끝난 v3 디자인 작업을 다시 시작하는 근거로 삼으면 안 됩니다.
