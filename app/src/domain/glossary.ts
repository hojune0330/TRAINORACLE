...
export const GLOSSARY: Record<TermId, GlossaryEntry> = {
  ...
  "plan-beta-basis": {
    label: "베타 계획의 근거",
    short: "현재 베타는 준비 목표, 훈련 경험, 훈련 가능 일수, 계획 길이와 현재 안전 확인만 사용합니다.",
    detail: "최근 일지는 있는지만 확인하며 거리, RPE, 메모를 계획 수치에 반영하지 않습니다. 개인 페이스나 최근 훈련량도 추정하지 않습니다.",
  },
  "plan-option": {
    label: "계획 후보",
    short: "같은 입력에서 훈련일의 구성을 다르게 만든 두 가지 선택지예요.",
    detail: "한 후보는 편안한 달리기에 RPE 5~6인 날을 섞고, 다른 후보는 모든 훈련일을 RPE 2~4로 둡니다. 이름만 보고 안전하거나 우수하다고 판단할 수는 없습니다.",
  },
  "quality-session": {
    label: "조절 강도",
