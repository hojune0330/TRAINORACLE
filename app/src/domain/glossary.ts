...
export const GLOSSARY: Record<TermId, GlossaryEntry> = {
  ...
  "training-days": {
    label: "훈련할 수 있는 날",
    short: "학교생활, 다른 운동, 휴식을 함께 생각했을 때 7~10일 동안 실제로 달릴 수 있는 횟수예요.",
    detail: "목표로 채워야 하는 횟수가 아닙니다. 베타에서는 3~5일을 고를 수 있고, 고르지 않은 날은 휴식 또는 가벼운 회복일로 둡니다.",
  },
  "plan-frame": {
    label: "계획 길이",
  ...
  "plan-beta-basis": {
    label: "베타 계획의 근거",
    short: "현재 베타는 준비 목표, 훈련 경험, 고른 훈련 목적, 훈련 가능 일수, 계획 길이와 현재 안전 확인만 사용합니다.",
