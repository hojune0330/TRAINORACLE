    ...
    <section className="plan-candidates" aria-labelledby="plan-candidates-title">
      ...
      {onRefine !== undefined && (
        <PlanRefinePanel
          ...
          onRefine={onRefine}
          detailedTemplateAvailable={resolveDetailedPlanTemplateOptions(intake).length > 0}
        />
      )}
      <RacePlacementNotice state={generated.racePlacement} />
      {onChangeMethod !== undefined && resolveDetailedPlanTemplateOptions(intake).length > 0 && <PlanMethodPicker
