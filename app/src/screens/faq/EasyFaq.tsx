...
function faqItems(): readonly FaqItem[] {
  ...
  },
  {
    ...
    answer: features.sharing
      ...
      : "일지 원문과 메모는 이 기기를 쓰는 사용자만 봐요. 코치 연결과 계정 데이터 공유는 아직 열지 않았어요. 정원·배지·사용 가능 포인트 요약은 사용자가 직접 공유할 수 있지만 일지 내용은 포함하지 않아요.",
  },
  {
  ...
  },
  {
    ...
    answer: accountEnabled || features.sharing
      ? "어린 사용자의 개인정보와 공유 범위를 지키기 위한 절차예요. 보호자 확인 전에는 계정 동기화와 일지 데이터 공유를 열지 않아요. 이름이나 일지 내용을 넣지 않는 정원·배지 요약은 사용자가 직접 공유할 수 있어요."
      : "계정 동기화와 일지 데이터 공유는 아직 열지 않았어요. 나중에 열 때 만 14세 미만 사용자는 개인정보와 공유 범위를 지키기 위해 보호자 확인이 필요해요.",
  },
  {
