...
function faqItems(): readonly FaqItem[] {
  ...
  return [
  {
    ...
    answer: accountEnabled
      ? "네. 로그인 없이도 이 기기에서 일지와 훈련 계획을 쓸 수 있어요. 원하면 Google이나 이메일 확인 링크로 첫 200명 무료 계정 베타에 참여할 수 있어요. 로그인만으로 기기 데이터가 서버에 올라가지는 않아요."
      : "네. 지금은 로그인 없이 이 기기에서 일지를 쓸 수 있어요. 계정 기능을 열 때는 첫 200명에게 열리는 무료 베타로 시작할 예정이에요.",
  },
  {
    question: "지금 무엇을 할 수 있나요?",
    answer: accountEnabled
      ? "오늘의 일지, 달력과 9.5일 보기, 지난 일지, 백업·복원, 꾸미기와 선택 로그인을 사용할 수 있어요. 기록은 먼저 이 기기에 저장되고, 로그인만으로 자동 업로드되지 않아요."
