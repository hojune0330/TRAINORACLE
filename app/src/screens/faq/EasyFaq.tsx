...
function faqItems(): readonly FaqItem[] {
  ...
  return [
  {
    ...
    answer: accountEnabled
      ? "네. 무료예요. Google이나 이메일 확인 링크로 로그인해 첫 200명 무료 계정 베타에 참여하는 걸 권해요. 로그인하면 기록을 계정과 연결해 안전하게 남길 준비가 돼요."
      : "네. 지금은 로그인 없이 이 기기에서 일지를 쓸 수 있어요. 계정 기능을 열 때는 첫 200명에게 열리는 무료 베타로 시작할 예정이에요.",
  },
  {
    question: "지금 무엇을 할 수 있나요?",
    answer: accountEnabled
      ? "오늘의 일지, 달력과 9.5일 보기, 지난 일지, 백업·복원, 꾸미기와 로그인을 사용할 수 있어요. 기록을 안전하게 남기려면 로그인한 상태로 쓰는 걸 권해요."
      : "오늘의 일지, 달력과 9.5일 보기, 지난 일지, 백업·복원, 꾸미기를 사용할 수 있어요. 기록은 지금 이 기기에 저장돼요.",
  },
  {
  ...
  },
  {
    ...
    answer: features.planProposals
      ...
      : "아니요. 자동으로 계획을 바꾸는 기능은 열지 않았어요. 지금 표시되는 것은 저장한 계획이나 검토할 계획안이며, 사용자의 확인 없이 활성 계획을 바꾸지 않아요.",
  },
  {
  ...
  },
  {
    ...
    answer: "온라인 계정은 만 14세부터 제공해요. 만 14세가 되면 로그인해서 기록을 계정에 안전하게 남기는 걸 권해요. 그 전까지는 이 기기에서 일지를 쓰고 훈련 계획을 만들 수 있어요.",
  },
  {
    ...
    <section aria-labelledby="easy-faq-title" style={{ padding: "30px 20px 0" }}>
      ...
      <p style={{ fontFamily: "var(--sans)", fontSize: 12, lineHeight: 1.65, color: "var(--ink-3)", margin: "8px 0 16px" }}>
        {accountFeatureEnabled()
          ? "이 페이지는 쉬운 설명이에요. 개인정보 처리방침이나 이용 약관을 대신하지 않아요. 정식 문서는 더보기와 가입 화면에서 언제든 확인할 수 있어요."
