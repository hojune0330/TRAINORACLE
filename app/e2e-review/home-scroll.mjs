...
const nt = page.getByText("다음 훈련")
await nt.scrollIntoViewIfNeeded()
await page.waitForTimeout(200)
await page.screenshot({ path: "e2e-review/shots/22-home-next-training-scrolled.png" })
// grab the next-training card text
const card = await page.locator("section, article, div").filter({ hasText: "다음 훈련" }).last().textContent()
