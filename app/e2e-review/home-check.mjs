...
await page.screenshot({ path: "e2e-review/shots/21-home-next-training.png", fullPage: true })
const text = await page.textContent("body")
const idx = text.indexOf("1000m")
console.log("home contains '1000m':", idx >= 0, idx >= 0 ? text.slice(Math.max(0, idx-80), idx+40) : "")
await browser.close()
