...
export default defineConfig({
  testDir: "./e2e", testMatch: ["account-plan-service.spec.ts", "account-plan-collection-preparation.spec.ts", "account-plan-lock.spec.ts"], outputDir: "./test-results/account-plan-service",
