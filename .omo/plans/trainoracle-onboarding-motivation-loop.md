...
- [x] 8. Obtain, verify, and publish the Fable UX/copy artifact
...
- [x] 9. Run Terra Very High contract binding and scenario preparation
...
- [x] 10. Run Sol High advisory preflight and create the pending activation packet
