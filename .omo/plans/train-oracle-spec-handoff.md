# train-oracle-spec-handoff - Work Plan
...
- Evidence: .omo/evidence/task-<N>-train-oracle-spec-handoff.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-train-oracle-spec-handoff.<ext>
