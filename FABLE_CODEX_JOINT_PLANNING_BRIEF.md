...
version: 0.1
status: PRE_MEETING_WORKING_BRIEF
owner: COACH_HOJUNE
contributors:
  - FABLE_PROJECT_LEAD_AI
  - CODEX
baseline_commit: 55f6ea2d9c85fe67c4bcc6606789b0f94dff23c2
...
이 문서는 Fable과 Codex가 TrainOracle의 다음 제품화 단계를 함께 결정하기 위한 사전 회의 자료다.
...
- Fable 답변을 받은 뒤 소유자가 결정해야 할 회의 안건
- 결정 이후의 권장 실행 순서
...
- GitHub `origin/main`: `55f6ea2`
- 열린 PR: 0건
- 열린 작업 이슈: `#42`, `#21`
- 최신 Fable 지시: `CODEX_WORK_ORDER_008.md`, `CODEX_WORK_ORDER_009.md`
...
## 10. Fable 답변 수신 후 합의 방법

Fable 답변이 오면 다음 형식으로 병합한다.

| 항목 | Codex 사전안 | Fable 의견 | 공통점 | 충돌 | Coach Hojune 결정 |
|---|---|---|---|---|---|
| D1 계획 사용자 | PENDING | PENDING | PENDING | PENDING | PENDING |
| D2 데이터 진실성 | PENDING | PENDING | PENDING | PENDING | PENDING |
| D3 메모 정책 | PENDING | PENDING | PENDING | PENDING | PENDING |
| D4 계획 MVP | PENDING | PENDING | PENDING | PENDING | PENDING |
| D5 순서·소유권 | PENDING | PENDING | PENDING | PENDING | PENDING |
...
1. Fable의 독립 기획 답변을 받는다.
2. D1~D5 비교표를 채운다.
3. Coach Hojune의 결정을 기록한다.
4. 결정된 범위만 대상으로 실행 가능한 단일 계획과 다음 Work Order를 만든다.
